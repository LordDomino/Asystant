...
public class GUI_RecordsPane extends JPanel {
  ...
  public GUI_RecordsPane() throws Exception {
    super();
    ...
    JLabel HEADER = new JLabel("Records pane"); HEADER.setFont(new Font(Fonts.DEFAULT_FAMILY_HEADER, Font.BOLD, 16));
    ...
    CLabel FIELDLABEL_1 = new CLabel("Group name");
    CLabel FIELDLABEL_2 = new CLabel("Section name");
    CLabel FIELDLABEL_3 = new CLabel("Criteria 1");
    CLabel FIELDLABEL_4 = new CLabel("Criteria 2");
    CTextField TEXTFIELD_1 = new CTextField();
    CTextField TEXTFIELD_2 = new CTextField();
    CTextField TEXTFIELD_3 = new CTextField();
    CTextField TEXTFIELD_4 = new CTextField();
