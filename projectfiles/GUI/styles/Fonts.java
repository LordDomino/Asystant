...
public class Fonts {
    ...
    public static final Font DEFAULT_LABEL = new Font(DEFAULT_FAMILY_BODY, Font.PLAIN, 15);
    ...
    public static final Font DEFAULT_SECTIONLABEL = new Font(DEFAULT_FAMILY_HEADER, Font.BOLD, 20);
}
