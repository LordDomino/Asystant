...
public class testFormField {
    public static void main(String args[]) throws Exception {
        ...
        CDetailedMultipleChoice dmc = new CDetailedMultipleChoice("Header", "Details label", CDetailedMultipleChoice.HORIZONTAL, CDetailedMultipleChoice.VERTICAL, "ICT", "HE", "ABM", "STEM", "HUMSS");
